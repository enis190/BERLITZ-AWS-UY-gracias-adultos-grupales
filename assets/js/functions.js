...
jQuery($=> {
    ...
    $(".c-wsp").addClass("c-visible");

    $window.on("scroll", function () {
        if ($window.scrollTop() > amountScrolled) {
            $(".back-top").addClass("back-top-visible");
            $(".block-social").addClass("c-visible");
            $(".c-wsp").addClass("c-visible");
        } else {
            $(".back-top").addClass("back-top-visible");
            $(".block-social").removeClass("c-visible");
            $(".c-wsp").addClass("c-visible");
    ...
    let backBtn_coti = $(".btn_cotizar");
    backBtn_coti.on("click", function () {
    ...
    $(".btn_nosotros").on("click", function () {
        if ( matchMedia( 'only screen and (min-width: 1200px)' ).matches ) 
        {
            $root.animate({
                scrollTop: 0
    ...
    $(".btn_inscribete").on("click", function () {
        if ( matchMedia( 'only screen and (min-width: 1200px)' ).matches ) 
        {
            $root.animate({
                scrollTop: 1200
    ...
    $(".btn_testimonio").on("click", function () {
        if ( matchMedia( 'only screen and (min-width: 1200px)' ).matches ) 
        {
            $root.animate({
                scrollTop: 0
